...
% Combustion
    ...
    generators(i).eng.mFCycMax  = 0.001282061263940;% Mass of fuel injected per cycle at rated load [kg]
...
% Turbocharger
    ...
    generators(i).eng.T_ref_turb       = T_ref_turb; %Reference temperature for turbine performance
