  ...
  if (nrhs>2 && mxIsChar(prhs[1])) {
    ...
    if (!strcmp(commandName,"library")) {
      ...
      if (!strcmp(machineName,"EngineSystemSubmodel")) {
        if (nrhs==3) {
          ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3563122550U);
          ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(39762659U);
          ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(767473734U);
          ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(4193442352U);
        } else if (nrhs==4) {
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
...

  {
    ...
    switch (chartFileNumber) {
     case 3:
      {
        if (strcmp(tpChksum, "iFXtHJFK1fB6XUARQmJWgG") == 0) {
...
mxArray* load_EngineSystemSubmodel_optimization_info(void)
{
  if (sRtwOptimizationInfoStruct==NULL) {
    sRtwOptimizationInfoStruct = sf_load_rtw_optimization_info(
      "EngineSystemSubmodel", "EngSimulation8RTFLEX68D_Transient");
