...
static void initialize_c6_Wartsila2StrokeSim_7S82XSSTune
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance);
static void initialize_params_c6_Wartsila2StrokeSim_7S82XSSTune
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance);
static void enable_c6_Wartsila2StrokeSim_7S82XSSTune
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance);
static void disable_c6_Wartsila2StrokeSim_7S82XSSTune
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c6_Wartsila2StrokeSim_7S82XSSTune
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance);
static void set_sim_state_c6_Wartsila2StrokeSim_7S82XSSTune
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance, const
   mxArray *c6_st);
static void finalize_c6_Wartsila2StrokeSim_7S82XSSTune
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance);
static void sf_gateway_c6_Wartsila2StrokeSim_7S82XSSTune
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance);
static void mdl_start_c6_Wartsila2StrokeSim_7S82XSSTune
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance);
static void initSimStructsc6_Wartsila2StrokeSim_7S82XSSTune
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance);
...
static real_T c6_emlrt_marshallIn
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance, const
   mxArray *c6_b_effMech, const char_T *c6_identifier);
static real_T c6_b_emlrt_marshallIn
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance, const
   mxArray *c6_u, const emlrtMsgIdentifier *c6_parentId);
static uint8_T c6_c_emlrt_marshallIn
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance, const
   mxArray *c6_b_is_active_c6_Wartsila2StrokeSim_7S82XSSTune, const char_T
   *c6_identifier);
  ...
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance)
{
  ...
  chartInstance->c6_is_active_c6_Wartsila2StrokeSim_7S82XSSTune = 0U;
}
  ...
  (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance)
{
  ...
  c6_b_u = chartInstance->c6_is_active_c6_Wartsila2StrokeSim_7S82XSSTune;
  c6_c_y = NULL;
   ...
   mxArray *c6_st)
{
  ...
  *chartInstance->c6_effMech = c6_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c6_is_active_c6_Wartsila2StrokeSim_7S82XSSTune =
    c6_c_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c6_u, 1)),
    "is_active_c6_Wartsila2StrokeSim_7S82XSSTune");
  sf_mex_destroy(&c6_u);
   ...
   *c6_identifier)
{
  ...
  c6_y = c6_d_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c6_b_is_active_c6_Wartsila2StrokeSim_7S82XSSTune), &c6_thisId);
  sf_mex_destroy(&c6_b_is_active_c6_Wartsila2StrokeSim_7S82XSSTune);
  return c6_y;
}
...
void sf_c6_Wartsila2StrokeSim_7S82XSSTune_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c6_Wartsila2StrokeSim_7S82XSSTune_get_post_codegen_info(void);
mxArray *sf_c6_Wartsila2StrokeSim_7S82XSSTune_get_autoinheritance_info(void)
{
...

  {
    mxArray* mxPostCodegenInfo =
      sf_c6_Wartsila2StrokeSim_7S82XSSTune_get_post_codegen_info();
...
mxArray *sf_c6_Wartsila2StrokeSim_7S82XSSTune_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c6_Wartsila2StrokeSim_7S82XSSTune_jit_fallback_info(void)
{
...
mxArray *sf_c6_Wartsila2StrokeSim_7S82XSSTune_updateBuildInfo_args_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c6_Wartsila2StrokeSim_7S82XSSTune
  (void)
{
  ...
  const char *infoEncStr[] = {
    "100 S1x2'type','srcId','name','auxInfo'{{M[1],M[5],T\"effMech\",},{M[8],M[0],T\"is_active_c6_Wartsila2StrokeSim_7S82XSSTune\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 2, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c6_Wartsila2StrokeSim_7S82XSSTune_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c6_Wartsila2StrokeSim_7S82XSSTune(void
  *chartInstanceVar)
{
  initialize_params_c6_Wartsila2StrokeSim_7S82XSSTune
    ((SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct*) chartInstanceVar);
  initialize_c6_Wartsila2StrokeSim_7S82XSSTune
    ((SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c6_Wartsila2StrokeSim_7S82XSSTune(void
  *chartInstanceVar)
{
  enable_c6_Wartsila2StrokeSim_7S82XSSTune
    ((SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c6_Wartsila2StrokeSim_7S82XSSTune(void
  *chartInstanceVar)
{
  disable_c6_Wartsila2StrokeSim_7S82XSSTune
    ((SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c6_Wartsila2StrokeSim_7S82XSSTune(void
  *chartInstanceVar)
{
  sf_gateway_c6_Wartsila2StrokeSim_7S82XSSTune
    ((SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct*) chartInstanceVar);
}

static const mxArray* sf_opaque_get_sim_state_c6_Wartsila2StrokeSim_7S82XSSTune
  (SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c6_Wartsila2StrokeSim_7S82XSSTune
    ((SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c6_Wartsila2StrokeSim_7S82XSSTune(SimStruct*
  S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c6_Wartsila2StrokeSim_7S82XSSTune
    ((SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct*)
     chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c6_Wartsila2StrokeSim_7S82XSSTune(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ...
    finalize_c6_Wartsila2StrokeSim_7S82XSSTune
      ((SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc6_Wartsila2StrokeSim_7S82XSSTune
    ((SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c6_Wartsila2StrokeSim_7S82XSSTune(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c6_Wartsila2StrokeSim_7S82XSSTune(SimStruct *S)
{
...
static void mdlRTW_c6_Wartsila2StrokeSim_7S82XSSTune(SimStruct *S)
{
...
static void mdlStart_c6_Wartsila2StrokeSim_7S82XSSTune(SimStruct *S)
{
  SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct *)utMalloc
    (sizeof(SFc6_Wartsila2StrokeSim_7S82XSSTuneInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c6_Wartsila2StrokeSim_7S82XSSTune;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c6_Wartsila2StrokeSim_7S82XSSTune;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c6_Wartsila2StrokeSim_7S82XSSTune;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c6_Wartsila2StrokeSim_7S82XSSTune;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c6_Wartsila2StrokeSim_7S82XSSTune;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c6_Wartsila2StrokeSim_7S82XSSTune;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c6_Wartsila2StrokeSim_7S82XSSTune;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c6_Wartsila2StrokeSim_7S82XSSTune;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c6_Wartsila2StrokeSim_7S82XSSTune;
  chartInstance->chartInfo.mdlStart = mdlStart_c6_Wartsila2StrokeSim_7S82XSSTune;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c6_Wartsila2StrokeSim_7S82XSSTune;
...
void c6_Wartsila2StrokeSim_7S82XSSTune_method_dispatcher(SimStruct *S, int_T
  method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c6_Wartsila2StrokeSim_7S82XSSTune(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c6_Wartsila2StrokeSim_7S82XSSTune(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c6_Wartsila2StrokeSim_7S82XSSTune(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c6_Wartsila2StrokeSim_7S82XSSTune_method_dispatcher.\n"
