...
{
  extern unsigned int
    sf_EngSimulation8CylInline2TC_Transient_process_check_sum_call( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if (sf_EngSimulation8CylInline2TC_Transient_process_check_sum_call(nlhs,plhs,
       nrhs,prhs))
    return 1;
  return 0;
}
...
{
  extern unsigned int
    sf_EngSimulation8CylInline2TC_Transient_autoinheritance_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  ...
  if (strcmp(machineName, "EngSimulation8CylInline2TC_Transient") == 0) {
    const mxArray *newRhs[3] = { NULL, NULL, NULL };

    newRhs[0] = prhs[0];
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_EngSimulation8CylInline2TC_Transient_autoinheritance_info(nlhs,
      plhs,3,newRhs);
  }
...
{
  extern unsigned int
    sf_EngSimulation8CylInline2TC_Transient_third_party_uses_info( int nlhs,
    mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  char commandName[64];
  char machineName[128];
  if (nrhs < 4) {
  ...
  if (strcmp(machineName, "EngSimulation8CylInline2TC_Transient") == 0) {
    ...
    newRhs[1] = prhs[2];
    newRhs[2] = prhs[3];
    return sf_EngSimulation8CylInline2TC_Transient_third_party_uses_info(nlhs,
      plhs,3,newRhs);
  }
  ...
  plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if (strcmp(machineName, "EngSimulation8CylInline2TC_Transient") == 0) {
    ...
    newRhs[1] = prhs[2];
    return
      sf_EngSimulation8CylInline2TC_Transient_get_eml_resolved_functions_info
      (nlhs,plhs,2,newRhs);
  }
...
extern unsigned int sf_EngSimulation8CylInline2TC_Transient_method_dispatcher
...
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
  ...
  method, void *data)
{
  if (!strcmp(machineName,"EngSimulation8CylInline2TC_Transient")) {
    return(sf_EngSimulation8CylInline2TC_Transient_method_dispatcher
...
extern void EngSimulation8CylInline2TC_Transient_terminator(void);
void sf_machine_global_terminator(void)
{
  sfGlobalMdlStartCallCounts--;
  if (sfGlobalMdlStartCallCounts == 0) {
    EngSimulation8CylInline2TC_Transient_terminator();
...
extern void EngSimulation8CylInline2TC_Transient_initializer(void);
extern void EngSimulation8CylInline2TC_Transient_register_exported_symbols
  (SimStruct* S);
extern void EngSimulation8CylInline2TC_Transient_debug_initialize(struct
  SfDebugInstanceStruct*);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  EngSimulation8CylInline2TC_Transient_register_exported_symbols(S);
}
...
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if (sfGlobalMdlStartCallCounts == 1) {
    ...
    if (!simModeIsRTWGen) {
      EngSimulation8CylInline2TC_Transient_debug_initialize
