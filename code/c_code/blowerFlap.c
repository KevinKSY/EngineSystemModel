...
#define S_FUNCTION_NAME blower
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          3
/* Input Port  0 */
#define IN_PORT_0_NAME      pTF_u
...
/* Input Port  2 */
#define IN_PORT_2_NAME      blowerRun
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      dmEmb_u
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      dmEmb_d
...
/* Output Port  2 */
#define OUT_PORT_2_NAME      powBlower
...
#define NPARAMS              3
/* Parameter  1 */
#define PARAMETER_0_NAME      effBlower
#define PARAMETER_0_DTYPE     real_T
#define PARAMETER_0_COMPLEX   COMPLEX_NO
/* Parameter  2 */
#define PARAMETER_1_NAME      coeffBlowerFlow
...
{
    const real_T   *pTF_u  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *pTF_d  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *blowerRun  = (const real_T*) ssGetInputPortSignal(S,2);
    real_T        *dmEmb_u  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *dmEmb_d  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *powBlower  = (real_T *)ssGetOutputPortRealSignal(S,2);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const real_T  *effBlower  = (const real_T *)mxGetData(PARAM_DEF0(S));
    const real_T  *coeffBlowerFlow  = (const real_T *)mxGetData(PARAM_DEF1(S));
    const real_T  *fs  = (const real_T *)mxGetData(PARAM_DEF2(S));

    blower_Outputs_wrapper(pTF_u, pTF_d, blowerRun, dmEmb_u, dmEmb_d, powBlower, effBlower, p_width0, coeffBlowerFlow, p_width1, fs, p_width2);
}
