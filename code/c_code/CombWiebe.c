...
#define S_FUNCTION_NAME CombWiebe
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          5
/* Input Port  0 */
#define IN_PORT_0_NAME      combState
...
extern void CombWiebe_Outputs_wrapper(const real_T *combState,
...
extern void CombWiebe_Update_wrapper(const real_T *combState,
                          const real_T *phiComb,
                          const real_T *phiIg,
                          const real_T *mqf,
                          const real_T *omega,
...
{
    const real_T   *combState  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *phiComb  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *phiIg  = (const real_T*) ssGetInputPortSignal(S,2);
    const real_T   *mqf  = (const real_T*) ssGetInputPortSignal(S,3);
    const real_T   *omega  = (const real_T*) ssGetInputPortSignal(S,4);
    real_T        *dmEmb  = (real_T *)ssGetOutputPortRealSignal(S,0);
    const real_T   *xD = ssGetDiscStates(S);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const int_T   p_width1  = mxGetNumberOfElements(PARAM_DEF1(S));
    const real_T  *hn  = (const real_T *)mxGetData(PARAM_DEF0(S));
    const real_T  *wiebePara  = (const real_T *)mxGetData(PARAM_DEF1(S));

    CombWiebe_Outputs_wrapper(combState, phiComb, phiIg, mqf, omega, dmEmb, xD, hn, p_width0, wiebePara, p_width1);
}
...
/* Function: mdlUpdate ======================================================
  ...
  static void mdlUpdate(SimStruct *S, int_T tid)
  {
    ...
    CombWiebe_Update_wrapper(combState, phiComb, phiIg, mqf, omega, dmEmb,  xD, hn, p_width0, wiebePara, p_width1);
}
