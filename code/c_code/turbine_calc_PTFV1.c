...
#define S_FUNCTION_NAME turbine_calc_PTFV1
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Parameter  2 */
#define PARAMETER_1_NAME      turb_flow_map
#define PARAMETER_1_DTYPE     real_T
#define PARAMETER_1_COMPLEX   COMPLEX_NO
/* Parameter  3 */
#define PARAMETER_2_NAME      turb_eff_map
...
extern void turbine_calc_PTFV1_Outputs_wrapper(const real_T *pu,
                          const real_T *Tu,
                          const real_T *Fu,
                          const real_T *pd,
                          const real_T *Td,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T  *turb_flow_map  = (const real_T *)mxGetData(PARAM_DEF1(S));
    const real_T  *turb_eff_map  = (const real_T *)mxGetData(PARAM_DEF2(S));
    ...
    turbine_calc_PTFV1_Outputs_wrapper(pu, Tu, Fu, pd, Td, Fd, omegat,
            dmu, deu, dmbu, dmd, ded, dmbd, Tqt, eta_ic, Td_calc, flow_prev, 
            eta_prev, fs, p_width0, turb_flow_map, p_width1, turb_eff_map, 
