...
#define S_FUNCTION_NAME GetExhVVArea
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          3
/* Input Port  0 */
#define IN_PORT_0_NAME      lift
...
extern void GetExhVVArea_Outputs_wrapper(const real_T *lift,
                          const real_T *pIn,
                          const real_T *pOut,
                          real_T *aOpen,
                          real_T *Cd,
...
{
    const real_T   *lift  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *pIn  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *pOut  = (const real_T*) ssGetInputPortSignal(S,2);
    real_T        *aOpen  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *Cd  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *aEff  = (real_T *)ssGetOutputPortRealSignal(S,2);
    ...
    const real_T  *Dv  = (const real_T *)mxGetData(PARAM_DEF0(S));
    const real_T  *beta  = (const real_T *)mxGetData(PARAM_DEF1(S));
    const real_T  *w  = (const real_T *)mxGetData(PARAM_DEF2(S));
    const real_T  *Dp  = (const real_T *)mxGetData(PARAM_DEF3(S));
    const real_T  *Ds  = (const real_T *)mxGetData(PARAM_DEF4(S));
    const real_T  *coeffCdCorrP  = (const real_T *)mxGetData(PARAM_DEF5(S));
    const real_T  *coeffCdCorrQ  = (const real_T *)mxGetData(PARAM_DEF6(S));
    const real_T  *coeffCdCorrPR  = (const real_T *)mxGetData(PARAM_DEF7(S));

    GetExhVVArea_Outputs_wrapper(lift, pIn, pOut, aOpen, Cd, aEff, Dv, p_width0, beta, p_width1, w, p_width2, Dp, p_width3, Ds, p_width4, coeffCdCorrP, p_width5, coeffCdCorrQ, p_width6, coeffCdCorrPR, p_width7);
}
