...
#define S_FUNCTION_NAME combState
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  0 */
#define OUT_PORT_0_NAME      combStateO
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      phiComb
...
#define NPARAMS              3
/* Parameter  1 */
#define PARAMETER_0_NAME      mqfCycMax
...
/* Parameter  3 */
#define PARAMETER_2_NAME      nStroke
...
extern void combState_Outputs_wrapper(const real_T *phi,
                          const real_T *phiInj,
                          const real_T *uGov,
                          const real_T *omega,
                          const real_T *temp,
