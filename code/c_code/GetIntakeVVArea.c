...
#define S_FUNCTION_NAME GetIntakeVVArea
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void GetIntakeVVArea_Outputs_wrapper(const real_T *lift,
                          const real_T *pIn,
                          const real_T *pOut,
                          real_T *aOpen,
                          real_T *Cd,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetIntakeVVArea_Outputs_wrapper(lift, pIn, pOut, aOpen, Cd, aEff, Dv, p_width0, beta, p_width1, w, p_width2, Dp, p_width3, Ds, p_width4);
}
