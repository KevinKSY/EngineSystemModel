...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T  *uBR  = (const real_T *)mxGetData(PARAM_DEF1(S));
    const real_T  *DPhiMix  = (const real_T *)mxGetData(PARAM_DEF2(S));
    const real_T  *phiMix0  = (const real_T *)mxGetData(PARAM_DEF3(S));
    const real_T  *alpha  = (const real_T *)mxGetData(PARAM_DEF4(S));
    const real_T  *hn  = (const real_T *)mxGetData(PARAM_DEF5(S));
    const real_T  *p0  = (const real_T *)mxGetData(PARAM_DEF6(S));
    const real_T  *T0  = (const real_T *)mxGetData(PARAM_DEF7(S));
    const real_T  *F0  = (const real_T *)mxGetData(PARAM_DEF8(S));
    const real_T  *V0  = (const real_T *)mxGetData(PARAM_DEF9(S));

    ThdynCV2ZoneConv_Outputs_wrapper(dmEmb, dV, dmfb, FComb, dQCyl, omega, phi, p, Tu, Fu, Vu, Tb, Fb, Vb, xC, fs, p_width0, uBR, p_width1, DPhiMix, p_width2, phiMix0, p_width3, alpha, p_width4, hn, p_width5, p0, p_width6, T0, p_width7, F0, p_width8, V0, p_width9);
}
...
/* Function: mdlDerivatives =================================================
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    ThdynCV2ZoneConv_Derivatives_wrapper(dmEmb, dV, dmfb, FComb, dQCyl, omega, phi, p, Tu, Fu, Vu, Tb, Fb, Vb,dx,  xC, fs, p_width0, uBR, p_width1, DPhiMix, p_width2, phiMix0, p_width3, alpha, p_width4, hn, p_width5, p0, p_width6, T0, p_width7, F0, p_width8, V0, p_width9);
}
