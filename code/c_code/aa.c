...
#define NPARAMS              1
/* Parameter  1 */
#define PARAMETER_0_NAME      param1
...
extern void aa_Outputs_wrapper(const real_T *u0,
                          real_T *y0, 
                           const int8_T  *param1, const int_T p_width0);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const int8_T  *param1  = (const int8_T *)mxGetData(PARAM_DEF0(S));

    aa_Outputs_wrapper(u0, y0, param1, p_width0);
}
