  ...
  real_T *Cv, real_T *K)
{
  ...
  EP3 = ((3.514956 - 0.005026 * V) + TT * ((0.131438 - 0.383504 * V) + TT * (EP2
    ...
    V))))))) - ZZT1 * TT;
  FC4 = ((((3.5566 - 0.0659 * V) * log(T) + ((2.972979 + 0.55314 *
             V) + TT * ((0.0583837 - 0.485001 * V) + TT * ((0.871349 + 0.0698183
    * V) + TT * ((-0.451556 - 0.0028772 * V) + TT * ((0.109164 - 0.000693663 * V)
    + TT * ((0.0129754 + 9.20231E-5 * V) + TT * (0.000608234 - 2.99679E-6 * V))))))))
          - (-0.805214 + V * (-0.400981 + V * (5.76989 + 0.060056 * V)))) -
         log(PP)) - FC7 * (0.000277105 - y) * FC6 * (1.0 + z);
  ...
  *uT = (EP4 * (EP3 + T * ((PAT1 * 0.001 - ((FC7T * ((0.000277105 - y) * FC6 *
    ...
    1.0) - (0.000642217 - b_y)) / (TT * TT) * 0.001) * TT) - ZZT1 * 0.001)) -
         *RT * T) - *R;
  *sF = EP2 * FC4 + EP4 * (((((0.0659 * VF * log(T) + (0.55314 -
    TT * (0.485001 + TT * (0.0698183 + TT * (-0.0028772 + TT * (-0.000693663 +
    TT * (9.20231E-5 - 2.99679E-6 * TT)))))) * VF) - (-0.400981 + V * (11.53978
    + 0.180168 * V)) * VF) + FC7 * FC2F * FC6 * (1.0 + z)) + FC7 * (0.000277105
    - y) * FC6F * (1.0 + z)) + FC7 * (0.000277105 - y) * FC6 * FC8F);
