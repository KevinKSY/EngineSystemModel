...
static void initialize_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance);
static void initialize_params_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance);
static void enable_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance);
static void disable_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance);
static void c2_update_debugger_state_c2_Wartsila2StrokeSim_7S82XSSTune_Blowe
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance);
static void set_sim_state_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance,
   const mxArray *c2_st);
static void finalize_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance);
static void sf_gateway_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance);
static void mdl_start_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance);
static void initSimStructsc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance);
...
static real_T c2_emlrt_marshallIn
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance,
   const mxArray *c2_b_dmbd, const char_T *c2_identifier);
...
static uint8_T c2_d_emlrt_marshallIn
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance,
   const mxArray *c2_b_is_active_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit,
  ...
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance)
{
  ...
  chartInstance->c2_is_active_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit = 0U;
}
  ...
  (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance)
{
  ...
  c2_g_hoistedGlobal =
    chartInstance->c2_is_active_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
   ...
   const mxArray *c2_st)
{
  ...
  *chartInstance->c2_dmu = c2_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c2_is_active_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit =
    ...
    "is_active_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit");
  sf_mex_destroy(&c2_u);
  c2_update_debugger_state_c2_Wartsila2StrokeSim_7S82XSSTune_Blowe(chartInstance);
...
static const mxArray *c2_sf_marshallOut(void *chartInstanceVoid, void *c2_inData)
{
  ...
  const mxArray *c2_y = NULL;
  SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance;
  chartInstance = (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *)
    chartInstanceVoid;
   ...
   const char_T *c2_identifier)
{
  ...
  c2_y = c2_e_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c2_b_is_active_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit), &c2_thisId);
  sf_mex_destroy(&c2_b_is_active_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit);
  return c2_y;
}
...
void sf_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_get_check_sum(mxArray *plhs[])
{
...
mxArray* sf_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_get_post_codegen_info
  (void);
mxArray *sf_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_get_autoinheritance_info
  (void)
{
...
mxArray *sf_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_third_party_uses_info
  (void)
{
...
mxArray *sf_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_jit_fallback_info(void)
{
...
mxArray
  *sf_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_updateBuildInfo_args_info(void)
{
...
static const mxArray
  *sf_get_sim_state_info_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[14],T\"dEd\",},{M[1],M[7],T\"dEu\",},{M[1],M[15],T\"dmbd\",},{M[1],M[12],T\"dmbu\",},{M[1],M[13],T\"dmd\",},{M[1],M[5],T\"dmu\",},{M[8],M[0],T\"is_active_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_get_check_sum(&mxChecksum);
...
static void sf_opaque_initialize_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (void *chartInstanceVar)
{
  chart_debug_initialization
    (((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
      chartInstanceVar)->S,0);
  initialize_params_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
    ((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
     chartInstanceVar);
  initialize_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
    ((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_enable_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(void
  *chartInstanceVar)
{
  enable_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
    ((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_disable_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(void
  *chartInstanceVar)
{
  disable_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
    ((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
     chartInstanceVar);
}

static void sf_opaque_gateway_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(void
  *chartInstanceVar)
{
  sf_gateway_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
    ((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
     chartInstanceVar);
}

static const mxArray*
  sf_opaque_get_sim_state_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(SimStruct*
  S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  return get_sim_state_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
    ((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
     chartInfo->chartInstance);        /* raw sim ctx */
}

static void sf_opaque_set_sim_state_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  set_sim_state_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
    ((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
     chartInfo->chartInstance, st);
}

static void sf_opaque_terminate_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(void
  *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
                    chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_optimization_info();
    }

    finalize_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
      ((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
       chartInstanceVar);
...
{
  initSimStructsc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
    ((SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct*)
     chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit
  (SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct =
      load_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_optimization_info();
...
static void mdlRTW_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(SimStruct *S)
{
  SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct *)
    utMalloc(sizeof(SFc2_Wartsila2StrokeSim_7S82XSSTune_BlowerFitInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
  chartInstance->chartInfo.enableChart =
    sf_opaque_enable_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
  chartInstance->chartInfo.disableChart =
    sf_opaque_disable_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW =
    mdlRTW_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
  chartInstance->chartInfo.mdlStart =
    mdlStart_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit;
...
void c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_method_dispatcher(SimStruct *S,
  int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c2_Wartsila2StrokeSim_7S82XSSTune_BlowerFit_method_dispatcher.\n"
