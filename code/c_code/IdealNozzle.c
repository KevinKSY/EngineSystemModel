...
#define S_FUNCTION_NAME IdealNozzle
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
/* %%%-SFUNWIZ_defines_Changes_BEGIN --- EDIT HERE TO _END */
#define NUM_INPUTS          7
/* Input Port  0 */
#define IN_PORT_0_NAME      A_eff
...
extern void IdealNozzle_Outputs_wrapper(const real_T *A_eff,
                          const real_T *pu,
                          const real_T *Tu,
                          const real_T *Fu,
                          const real_T *pd,
...
{
    const real_T   *A_eff  = (const real_T*) ssGetInputPortSignal(S,0);
    const real_T   *pu  = (const real_T*) ssGetInputPortSignal(S,1);
    const real_T   *Tu  = (const real_T*) ssGetInputPortSignal(S,2);
    const real_T   *Fu  = (const real_T*) ssGetInputPortSignal(S,3);
    const real_T   *pd  = (const real_T*) ssGetInputPortSignal(S,4);
    const real_T   *Td  = (const real_T*) ssGetInputPortSignal(S,5);
    const real_T   *Fd  = (const real_T*) ssGetInputPortSignal(S,6);
    ...
    IdealNozzle_Outputs_wrapper(A_eff, pu, Tu, Fu, pd, Td, Fd, dmu, deu, dmbu, dmd, ded, dmbd, fs, p_width0);
}
