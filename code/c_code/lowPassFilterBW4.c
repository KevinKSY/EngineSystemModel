...
#define S_FUNCTION_NAME lowPassFilterBW4
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define NPARAMS              2
/* Parameter  1 */
#define PARAMETER_0_NAME      BW
#define PARAMETER_0_DTYPE     real_T
#define PARAMETER_0_COMPLEX   COMPLEX_NO
/* Parameter  2 */
#define PARAMETER_1_NAME      y0
...
#define CONT_STATES_IC       [y0,0,0,0]
...
extern void lowPassFilterBW4_Outputs_wrapper(real_T *y, const real_T *xC);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    lowPassFilterBW4_Outputs_wrapper(y, xC);
}
...
/* Function: mdlDerivatives =================================================
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    const real_T  *BW  = (const real_T *)mxGetData(PARAM_DEF0(S));
    const real_T  *y0  = (const real_T *)mxGetData(PARAM_DEF1(S));

    lowPassFilterBW4_Derivatives_wrapper(u, y,dx,  xC, BW, p_width0, y0, p_width1);
}
