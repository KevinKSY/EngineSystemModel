 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Mon Mar 16 11:41:31 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME GetXCombGas
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES "__SFB__GetCompCombGas.c__SFB__GetCompleteComb.c__SFB__GetEquilGrill.c__SFB__sum.c__SFB__GetCompCombGas_rtwutil.c__SFB__rt_nonfinite.c__SFB__rtGetInf.c__SFB__rtGetNaN.c"
#define PANELINDEX           6
...
extern void GetXCombGas_Outputs_wrapper(const real_T *p,
			const real_T *T,
			const real_T *F,
			real_T *x,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    GetXCombGas_Outputs_wrapper(p, T, F, x, fs, p_width0, T_L, p_width1, T_H, p_width2, FC, p_width3, xAir, p_width4);
