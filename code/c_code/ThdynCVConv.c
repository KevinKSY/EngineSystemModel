...
#define NUM_CONT_STATES      5
#define CONT_STATES_IC       [p0,T0,m0,mb0,V0]
...
#define MDL_INITIALIZE_CONDITIONS
 ...
 static void mdlInitializeConditions(SimStruct *S)
 {
   ...
   fs = (*mxGetPr(ssGetSFcnParam(S, 0)));
    ...
    F0 = (*mxGetPr(ssGetSFcnParam(S, 3)));
    
    xC[4] = (*mxGetPr(ssGetSFcnParam(S, 4)));   
    GetThdynCombGasZach(xC[0], xC[1], F0, &R, &h, &s, &u, &RF, &RP, &RT, 
        &uF, &uP, &uT, &Cp, &Cv, &K);
    xC[2] =  xC[0]*xC[4] / (R*xC[1]) ;
    xC[3] =  F0*fs / (1 + F0*fs) * xC[2] ;
 }
