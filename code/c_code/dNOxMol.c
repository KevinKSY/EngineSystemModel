 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Mar 17 23:59:00 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME dNOxMol
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
#define SOURCEFILES "__SFB__dNOx.c__SFB__GetCompCombGas.c__SFB__GetThdynCombGasZachV1.c__SFB__GetEquilGrill.c __SFB__GetCompleteComb.c __SFB__GetCompCombGas_rtwutil.c __SFB__rtGetNaN.c __SFB__rtGetInf.c __SFB__sum.c __SFB__rt_nonfinite.c"
#define PANELINDEX           6
...
extern void dNOxMol_Outputs_wrapper(const real_T *p,
			const real_T *T,
			const real_T *F,
			const real_T *V,
			const real_T *NOMol,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T   *NOMol  = (const real_T*) ssGetInputPortSignal(S,4);
    real_T        *dNOMol  = (real_T *)ssGetOutputPortRealSignal(S,0);
    ...
    const real_T  *T_L  = (const real_T *)mxGetData(PARAM_DEF1(S));
    const real_T  *T_H  = (const real_T *)mxGetData(PARAM_DEF2(S));
    const real_T  *FC  = (const real_T *)mxGetData(PARAM_DEF3(S));
    const real_T  *xAir  = (const real_T *)mxGetData(PARAM_DEF4(S));


    dNOxMol_Outputs_wrapper(p, T, F, V, NOMol, dNOMol, fs, p_width0, T_L, p_width1, T_H, p_width2, FC, p_width3, xAir, p_width4);
