...
#define S_FUNCTION_NAME resetCyc
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void resetCyc_Outputs_wrapper(const real_T *phi,
			real_T *reset, const real_T *phiClc,
			const real_T  *nStroke, const int_T  p_width0);

extern void resetCyc_Update_wrapper(const real_T *phi,
			real_T *phiClc, const real_T  *nStroke);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T        *reset  = (real_T *)ssGetOutputPortRealSignal(S,0);
    const real_T  *phiClc = (const real_T*)ssGetDWork(S,0);
    const int_T   p_width0  = mxGetNumberOfElements(PARAM_DEF0(S));
    const real_T  *nStroke  = (const real_T *)mxGetData(PARAM_DEF0(S));


    resetCyc_Outputs_wrapper(phi, reset, phiClc, nStroke, p_width0);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    resetCyc_Update_wrapper(phi, phiClc, nStroke);
}
