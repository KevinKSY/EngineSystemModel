 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Mar  3 13:12:31 2015
*/
#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME ThdynCVConvDX
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void ThdynCVConvDX_Outputs_wrapper(const real_T *dm,
			const real_T *dE,
			const real_T *dmf,
			const real_T *dV,
			real_T *dp,
...
extern void ThdynCVConvDX_Derivatives_wrapper(const real_T *dm,
			const real_T *dE,
			const real_T *dmf,
			const real_T *dV,
			const real_T *dp,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T        *dp  = (real_T *)ssGetOutputPortRealSignal(S,0);
    real_T        *dT  = (real_T *)ssGetOutputPortRealSignal(S,1);
    real_T        *dF  = (real_T *)ssGetOutputPortRealSignal(S,2);
    ...
    ThdynCVConvDX_Outputs_wrapper(dm, dE, dmf, dV, dp, dT, dF, xC, fs, p_width0, p0, p_width1, T0, p_width2, F0, p_width3, V0, p_width4);
...
/* Function: mdlDerivatives =================================================
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    ThdynCVConvDX_Derivatives_wrapper(dm, dE, dmf, dV, dp, dT, dF,dx,  xC, fs, p_width0, p0, p_width1, T0, p_width2, F0, p_width3, V0, p_width4);
}
