...
#define S_FUNCTION_NAME EngCylHeatTransfer
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
/* Output Port  1 */
#define OUT_PORT_1_NAME      tempWall
...
#define CONT_STATES_IC       [tempWall0]
...
extern void EngCylHeatTransfer_Outputs_wrapper(const real_T *pCyl,
...
extern void EngCylHeatTransfer_Derivatives_wrapper(const real_T *pCyl,
                          const real_T *tempCyl,
                          const real_T *vCyl,
                          const real_T *omega,
                          const real_T *dQ,
...
#define MDL_INITIALIZE_CONDITIONS
 ...
 static void mdlInitializeConditions(SimStruct *S)
 {
   ...
   xC[0] = (*mxGetPr(ssGetSFcnParam(S, 4)))*(*mxGetPr(ssGetSFcnParam(S, 3)));
 }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T        *tempWall  = (real_T *)ssGetOutputPortRealSignal(S,1);
    ...
    const real_T  *mCp  = (const real_T *)mxGetData(PARAM_DEF3(S));
    const real_T  *tempWall0  = (const real_T *)mxGetData(PARAM_DEF4(S));
    const real_T  *cCylHT  = (const real_T *)mxGetData(PARAM_DEF5(S));
    const real_T  *nCyl  = (const real_T *)mxGetData(PARAM_DEF6(S));

    EngCylHeatTransfer_Outputs_wrapper(pCyl, tempCyl, vCyl, omega, dQ, tempWall, xC, stroke, p_width0, B, p_width1, cAlpha, p_width2, mCp, p_width3, tempWall0, p_width4, cCylHT, p_width5, nCyl, p_width6);
}
...
/* Function: mdlDerivatives =================================================
  ...
  static void mdlDerivatives(SimStruct *S)
  {
    ...
    EngCylHeatTransfer_Derivatives_wrapper(pCyl, tempCyl, vCyl, omega, dQ, tempWall,dx,  xC, stroke, p_width0, B, p_width1, cAlpha, p_width2, mCp, p_width3, tempWall0, p_width4, cCylHT, p_width5, nCyl, p_width6);
}
