 ...
 *
  ...
  *  ------------------------------------------------------------------------- 
* Created: Tue Mar 17 00:51:02 2015
*/
...
extern void NOx_Outputs_wrapper(const real_T *p,
			const real_T *T,
			const real_T *F,
			const real_T *V,
			const real_T *phi,
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    const real_T   *phi  = (const real_T*) ssGetInputPortSignal(S,4);
    ...
    const real_T  *fs  = (const real_T *)mxGetData(PARAM_DEF1(S));
    const int_T   p_width2  = mxGetNumberOfElements(PARAM_DEF2(S));
    const real_T  *T_L  = (const real_T *)mxGetData(PARAM_DEF2(S));
    const int_T   p_width3  = mxGetNumberOfElements(PARAM_DEF3(S));
    const real_T  *T_H  = (const real_T *)mxGetData(PARAM_DEF3(S));
    const int_T   p_width4  = mxGetNumberOfElements(PARAM_DEF4(S));
    const real_T  *FC  = (const real_T *)mxGetData(PARAM_DEF4(S));
    const int_T   p_width5  = mxGetNumberOfElements(PARAM_DEF5(S));
    const real_T  *xAir  = (const real_T *)mxGetData(PARAM_DEF5(S));    

    NOx_Outputs_wrapper(p, T, F, V, phi, dNOMol, nStroke, p_width0, fs, 
            p_width1, T_L, p_width2, T_H, p_width3, FC, p_width4, 
            xAir, p_width5);
