...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    real_T        *dP = (real_T *)ssGetOutputPortRealSignal(S,4);
    real_T        *dT = (real_T *)ssGetOutputPortRealSignal(S,5);
    real_T        *dF = (real_T *)ssGetOutputPortRealSignal(S,6);
